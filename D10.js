...
console.log(splitMe("I failed the Benchmark"));
...
console.log(deleteOne("gravity", true));
console.log(deleteOne("gravity", false));
...
console.log(onlyLetters("I have 2 cats and 3 dogs")); 
...
console.log(isThisAnEmail("invalid-email.com"));
...
function isTodayMyBirthday() {
  const today = new Date();
  const birthday = new Date(today.getFullYear(), 2, 2); // 2 marzo
...
function addNewListItem() {
  ...
  newListItem.textContent = 'Inception';
